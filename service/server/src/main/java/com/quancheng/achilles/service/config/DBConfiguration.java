...
public class DBConfiguration {
    ...
    public final static String default_query_session="writeSqlSession";
    
    public final static String default_read_session="readSqlSession";
    /**数据平台数据库实例数据源*/
    /*=====ds read begin======*/
    @Primary
    ...
    @Bean(name = default_query_session)
